...
data <- data %>%
  ...
  mutate(Message_Int_n = as.numeric(Message_Int),
         ...
         Customer_sat_short = as.numeric(Customer_sat_short),
  ...
  select(Condition,Message_Int,Task_Type,Age,Gender,Degree,Customer_sat,Customer_sat_short,Orga_perc,Behav_Int,NFHI,Perc_cont,Social_pres,Product_inv,Chat_use,Message_Int_n,Task_Type_n)
